					...
					<form action="p_stock_search.php" method="get" id="portfolio_form" class="form-inline">
						<div class="form-group">
							...
							<div class="input_container" style="display: inline-block;">
								<input  class="form-control" id="stock" type="text" name="stock" onkeyup="autocomplet()" autocomplete="off">
			...
			<div class="col-md-4 col-sm-4 well" style=" height:475px;">
				...
				<div class="tab-content">
				  <div class="tab-pane active">
				  		<div class="table-responsive table-bordered" id="portfoliolist">
				  ...
				  <div class="tab-pane">
				  	<div class="table-responsive table-bordered" id="watchlist">

<?php
	...
	class StockTest extends PHPUnit_Framework_TestCase {
		...
		public function testIfNameTakesCharacters(){
			...
			$this->assertEquals("qwert12345!@#$%<>?",$a->getName());
		}
		...
		public function testClosingPrice() {
			...
			$this->assertEquals(10,$a->getClosingPrice());
		}
		public function testChangingClosingPrice(){
			$a = new Stock("Johnny","TST",10,12,12);
			$this->assertEquals(10,$a->getClosingPrice());
			$a->setClosingPrice(24);
			$this->assertEquals(24,$a->getClosingPrice());
		}
		...
		public function testNegaticeFractionClosingPrice(){
			$a = new Stock("Johnny","TST",-12.55,12,12);
			$this->assertEquals(-12.55,$a->getClosingPrice);
		}
